...
export default function ExercisePage({ exercise, onBack, onScoreUpdate }: ExercisePageProps) {
    ...
    <div className="page page--exercise">
      ...
      <div className="exercise-topbar">
        ...
        <div className="brand-header">
          <h1 className="brand-title">
            <span className="brand-part--clues">Clues in</span>{' '}
            <span className="brand-part--conversation">Conversation</span>
          </h1>
      ...
      <div className="exercise-main">
        ...
        <div className={`panel panel--coaching ${exerciseStarted ? '' : 'panel--hidden'}`}>
          <h2 className="section-title">Movement Score</h2>
          ...
          {exerciseStarted ? (
            ...
            <p className="coaching-placeholder">Start the exercise to see movement score</p>
          )}
        </div>
      </div>
